...
class TestDatabaseGuardTest {
    ...
    void refusesRealDatabase() {
        assertThatThrownBy(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5436/order_db"))
                .isInstanceOf(IllegalStateException.class)
                .hasMessageContaining("order_db");
    }

    @Test
    void allowsTestDatabaseAndNoDatabaseAtAll() {
        assertThatCode(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5436/order_db_test?sslmode=disable"))
    ...
    void refusesNameThatMerelyContainsTest() {
        ...
        assertThatThrownBy(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5436/order_db_testing"))
                .isInstanceOf(IllegalStateException.class);
    }
}
