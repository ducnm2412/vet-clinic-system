...
class TestDatabaseGuardTest {
    ...
    void refusesRealDatabase() {
        assertThatThrownBy(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5434/profile_db"))
                .isInstanceOf(IllegalStateException.class)
                .hasMessageContaining("profile_db");
    }

    @Test
    void allowsTestDatabaseAndNoDatabaseAtAll() {
        assertThatCode(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5434/profile_db_test?sslmode=disable"))
    ...
    void refusesNameThatMerelyContainsTest() {
        ...
        assertThatThrownBy(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5434/profile_db_testing"))
                .isInstanceOf(IllegalStateException.class);
    }
}
