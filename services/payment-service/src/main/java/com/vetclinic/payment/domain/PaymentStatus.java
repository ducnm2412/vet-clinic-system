...
public enum PaymentStatus {
    // Vừa tạo từ prescription.created (pet-service) — chưa có amount, chờ staff nhập tay.
    PENDING_AMOUNT,
    // Staff đã nhập amount (PUT .../amount) — chờ khách hàng thanh toán.
    PENDING_PAYMENT,
    // Đã thanh toán xong — payment-service publish payment.completed cho pet-service.
    COMPLETED,
