...
class TestDatabaseGuardTest {
    ...
    void refusesRealDatabase() {
        assertThatThrownBy(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5439/staff_db"))
                .isInstanceOf(IllegalStateException.class)
                .hasMessageContaining("staff_db");
    }

    @Test
    void allowsTestDatabaseAndNoDatabaseAtAll() {
        assertThatCode(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5439/staff_db_test?sslmode=disable"))
    ...
    void refusesNameThatMerelyContainsTest() {
        ...
        assertThatThrownBy(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5439/staff_db_testing"))
                .isInstanceOf(IllegalStateException.class);
    }
}
