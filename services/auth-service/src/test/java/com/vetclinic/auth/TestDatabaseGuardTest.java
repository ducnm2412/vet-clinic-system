...
class TestDatabaseGuardTest {
    ...
    void refusesRealDatabase() {
        assertThatThrownBy(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5433/auth_db"))
                .isInstanceOf(IllegalStateException.class)
                .hasMessageContaining("auth_db");
    }

    @Test
    void allowsTestDatabaseAndNoDatabaseAtAll() {
        assertThatCode(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5433/auth_db_test?sslmode=disable"))
    ...
    void refusesNameThatMerelyContainsTest() {
        ...
        assertThatThrownBy(() -> TestDatabaseGuard.checkUrl("jdbc:postgresql://localhost:5433/auth_db_testing"))
                .isInstanceOf(IllegalStateException.class);
    }
}
